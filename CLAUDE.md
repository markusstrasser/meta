...
- [ ] **Expand calibration canary beyond bootstrap** — 6→20 canaries across 4 categories (local-context, temporal/staleness, external-fact, adversarial/tricky). Increase runs 3→10 weekly, add monthly deep pipeline (20 runs, Sonnet). Add `requires_context` field for context-free canaries. Plan: `.claude/plans/c762d039-vendor-scan-impl.md` Part A. (Source: calibration-measurement-practical.md, bootstrap 2026-03-05, plan 2026-03-11)
