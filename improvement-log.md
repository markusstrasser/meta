...
- **Net actionable:** ONE — drift recurrence pair (SSH-burst fail2ban + pgrep self-match, 2 sessions each, transcript-verified, ungoverned) → escalated to `decisions-pending/2026-06-14-remote-ssh-ops-gotchas.md` (global-rule home = human-owned).
