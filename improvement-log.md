...
### [2026-06-14] [ ] EXIT-CODE-AS-REPORT-STATE: audit_corpus_sync exits 1 on drift-detected, RSI sweep misreads as crash (drift, incremental)
...
- **Root cause:** system-design
- **Status:** [ ] proposed — 3 distinct sessions (≥2 gate cleared) + code-verified mechanism. Single-variable change to one script's exit semantics; agent-infra-local blast radius.
