...
| `2026-06-12-defending-harness-verifier-patterns.md` | anthropics/defending-code-reference-harness mined — grade→judge two-tier gating, executable oracle, concrete-zero rubric, keep-rejects dedup | Building/editing verifier loops (hutter Grinder/Dreamer), evals graders/judges, any deterministic-screen→LLM-judge contract |
| `2026-06-12-symphony-orchestrator-reference.md` | openai/symphony reference — central orchestrator over Linear board, state-disposable/durability-outsourced, validates CAID hard-isolation + state-externalization; "no orchestrator" is workload-scoped not universal | Reconsidering OUTER-LOOP/orchestrator; any parallel-fan-out dispatch design; HITL checkpoint placement |
...
| `2026-06-13-goal-clarification-automation-design.md` | 2026 06 13 Goal Clarification Automation Design | TODO |
| `2026-06-13-lifescience-coverage-check.md` | Life-Science-Research Plugin Freshness Check | TODO |
...
| `2026-06-13-multiagent-state-coordination-prior-art.md` | Multi-agent shared-state — field converged on isolate-per-agent+merge-via-git (CAID 7.8pp); event-sourcing/locking NOT needed; agentlogs.db already WAL | Building any multi-agent state/locking/coordination; proposing event-sourcing/OCC/flock for agent state; choosing an orchestrator; "isn't concurrent-agent state solved?" |
...
| `2026-06-20-oh-my-openagent-primitives.md` | oh-my-openagent — extracted primitives, tricks & methods | TODO |
