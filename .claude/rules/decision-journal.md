...
**Cross-repo convention:** Cross-repo decisions live canonically in one repo (usually agent-infra for infrastructure). Affected repos get a one-line stub: `See [repo]/decisions/YYYY-MM-DD-slug.md`.
